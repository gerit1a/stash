...
class vttThumbnailsPlugin {
  ...
  setupThumbnailElement(data) {
    ...
    this.progressBarHolder.addEventListener('touchstart', this.registeredEvents.progressBarMouseEnter);
  ...
  onBarMouseenter() {
    ...
    this.progressBarHolder.addEventListener('touchmove', this.registeredEvents.progressBarMouseMove);
  ...
  onBarMouseleave() {
    if (this.registeredEvents.progressBarMouseMove) {
      ...
      this.progressBarHolder.removeEventListener('touchmove', this.registeredEvents.progressBarMouseMove);
    }
